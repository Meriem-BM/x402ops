...
const agentData = {
  ...
  activity: [
    { time: "10:24 AM", vendor: "OpenAI API", amount: 0.04, status: "Success", tx: "0x1a2b...3c4d" },
    { time: "10:15 AM", vendor: "Perplexity", amount: 0.08, status: "Success", tx: "0x5e6f...7g8h" },
    { time: "09:45 AM", vendor: "Anthropic API", amount: 0.12, status: "Success", tx: "0x9i0j...1k2l" },
    { time: "09:30 AM", vendor: "Unknown Vendor", amount: 5.0, status: "Blocked", tx: "—" },
    { time: "08:50 AM", vendor: "OpenAI API", amount: 0.06, status: "Success", tx: "0x3m4n...5o6p" },
  ],
  spendHistory: [
    { day: "Mon", amount: 3.2 },
    { day: "Tue", amount: 4.8 },
